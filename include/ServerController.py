...
from . import (HydrusNetworking, HydrusSessions, HydrusThreading, ServerDB,
               ServerServer)
...
class Controller(HydrusController.HydrusController):
    ...
    def SaveDirtyObjects(self):
        ...
        with HG.dirty_object_lock:
            ...
            dirty_services = [
                service for service in self._services if service.IsDirty()
            ]
    ...
    def SetServices(self, services):
        ...
        current_service_keys = set(
            self._service_keys_to_connected_ports.keys())
        future_service_keys = set(
