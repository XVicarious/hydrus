...
class CantRenderWithCVException(HydrusException):
    pass


class DataMissing(HydrusException):
    pass
...
class DBAccessException(HydrusException):
    pass


class FileMissingException(HydrusException):
    pass


class DirectoryMissingException(HydrusException):
    pass


class SerialisationException(HydrusException):
    pass


class NameException(HydrusException):
    pass


class ShutdownException(HydrusException):
    pass


class QtDeadWindowException(HydrusException):
    pass


class VetoException(HydrusException):
    pass
...
class ParseException(HydrusException):
    pass
...
class URLClassException(ParseException):
    pass
...
class NetworkException(HydrusException):
    pass
