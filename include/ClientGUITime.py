...
from . import (ClientGUICommon, ClientGUIScrolledPanels,
               ClientGUITopLevelWindows, ClientImporting, ClientImportOptions,
               HydrusData)
...
class EditCheckerOptions(ClientGUIScrolledPanels.EditPanel):
    ...
    def SetValue(self, checker_options):
        ...
        self._flat_check_period_checkbox.setChecked(
    ...
    def GetValue(self):
        ...
        return ClientImportOptions.CheckerOptions(intended_files_per_check,
                                                  never_faster_than,
                                                  never_slower_than,
                                                  death_file_velocity)
...
class VelocityCtrl(QW.QWidget):
    def __init__(self,
        ...
        self._num = QP.MakeQSpinBox(self,
                                    min=min_unit_value,
                                    max=max_unit_value,
                                    width=60)
        ...
        QP.AddToLayout(hbox, ClientGUICommon.BetterStaticText(self, mid_text),
                       CC.FLAGS_VCENTER)
