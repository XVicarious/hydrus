...
class SerialisableBaseNamed(SerialisableBase):
    ...
    def GetSerialisableTuple(self):
        ...
        return (self.SERIALISABLE_TYPE, self._name, self.SERIALISABLE_VERSION,
                self._GetSerialisableInfo())
...
class SerialisableDictionary(SerialisableBase, dict):
        ...
        for (key, value) in list(self.items()):
            ...
            if isinstance(key, SerialisableBase):
                ...
                if isinstance(value, SerialisableBase):
                    ...
                    serialisable_key_serialisable_value_pairs.append(
                        (serialisable_key, serialisable_value))

                else:

                    serialisable_value = value

                    serialisable_key_simple_value_pairs.append(
                        (serialisable_key, serialisable_value))
                ...
                if isinstance(value, SerialisableBase):
                    ...
                    simple_key_serialisable_value_pairs.append(
                        (serialisable_key, serialisable_value))
                    ...
                    simple_key_simple_value_pairs.append(
                        (serialisable_key, serialisable_value))

        return (simple_key_simple_value_pairs,
                simple_key_serialisable_value_pairs,
                serialisable_key_simple_value_pairs,
                serialisable_key_serialisable_value_pairs)
    ...
    def _InitialiseFromSerialisableInfo(self, serialisable_info):
        ...
        (simple_key_simple_value_pairs, simple_key_serialisable_value_pairs,
         serialisable_key_simple_value_pairs,
         serialisable_key_serialisable_value_pairs) = serialisable_info
        ...
        for (serialisable_key,
             serialisable_value) in serialisable_key_serialisable_value_pairs:
...
SERIALISABLE_TYPES_TO_OBJECT_TYPES[
    SERIALISABLE_TYPE_DICTIONARY] = SerialisableDictionary
        ...
        for (encoded_key, encoded_value) in serialisable_info:
            ...
            if isinstance(encoded_value, (list, tuple, set)):
                ...
                value = [
                    ...
                    for encoded_item in encoded_value
                ]
...
SERIALISABLE_TYPES_TO_OBJECT_TYPES[
    SERIALISABLE_TYPE_BYTES_DICT] = SerialisableBytesDictionary
