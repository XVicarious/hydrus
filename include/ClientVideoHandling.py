...
class GIFRenderer(object):
    def __init__(self, path, num_frames, target_resolution):
        ...
        if new_options.GetBoolean(
                'disable_cv_for_gifs') or cv2.__version__.startswith('2'):
        ...
        if self._cv_mode:
            ...
            try:
                ...
                numpy_image = HydrusImageHandling.ResizeNumPyImage(
                    numpy_image, self._target_resolution)
    ...
    def set_position(self, index):
        ...
        while self._next_render_index < index:
            self._GetCurrentFrame()
