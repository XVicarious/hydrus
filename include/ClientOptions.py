...
class ClientOptions(HydrusSerialisable.SerialisableBase):
    ...
    def _GetDefaultMediaViewOptions(self):
        ...
        media_view = HydrusSerialisable.SerialisableDictionary(
        )  # integer keys, so got to be cleverer dict
        ...
        if ClientGUIMPV.MPV_IS_AVAILABLE:
            ...
            video_zoom_info = (CC.MEDIA_VIEWER_SCALE_TO_CANVAS,
                               CC.MEDIA_VIEWER_SCALE_TO_CANVAS,
                               CC.MEDIA_VIEWER_SCALE_TO_CANVAS,
                               CC.MEDIA_VIEWER_SCALE_TO_CANVAS, False,
                               CC.ZOOM_LANCZOS4, CC.ZOOM_AREA)
            ...
            video_zoom_info = (CC.MEDIA_VIEWER_SCALE_100,
                               CC.MEDIA_VIEWER_SCALE_TO_CANVAS,
                               CC.MEDIA_VIEWER_SCALE_TO_CANVAS,
                               CC.MEDIA_VIEWER_SCALE_TO_CANVAS, True,
                               CC.ZOOM_LANCZOS4, CC.ZOOM_AREA)

        image_zoom_info = (CC.MEDIA_VIEWER_SCALE_TO_CANVAS,
                           CC.MEDIA_VIEWER_SCALE_TO_CANVAS,
                           CC.MEDIA_VIEWER_SCALE_TO_CANVAS,
                           CC.MEDIA_VIEWER_SCALE_TO_CANVAS, False,
                           CC.ZOOM_LANCZOS4, CC.ZOOM_AREA)
        gif_zoom_info = (CC.MEDIA_VIEWER_SCALE_TO_CANVAS,
                         CC.MEDIA_VIEWER_SCALE_TO_CANVAS,
                         CC.MEDIA_VIEWER_SCALE_TO_CANVAS,
                         CC.MEDIA_VIEWER_SCALE_TO_CANVAS, False,
                         CC.ZOOM_LANCZOS4, CC.ZOOM_AREA)
        flash_zoom_info = (CC.MEDIA_VIEWER_SCALE_TO_CANVAS,
                           CC.MEDIA_VIEWER_SCALE_TO_CANVAS,
                           CC.MEDIA_VIEWER_SCALE_TO_CANVAS,
                           CC.MEDIA_VIEWER_SCALE_TO_CANVAS, False,
                           CC.ZOOM_LINEAR, CC.ZOOM_LINEAR)

        null_zoom_info = (CC.MEDIA_VIEWER_SCALE_100, CC.MEDIA_VIEWER_SCALE_100,
                          CC.MEDIA_VIEWER_SCALE_100, CC.MEDIA_VIEWER_SCALE_100,
                          False, CC.ZOOM_LINEAR, CC.ZOOM_LINEAR)
        ...
        media_view[HC.GENERAL_IMAGE] = (
            CC.MEDIA_VIEWER_ACTION_SHOW_WITH_NATIVE, media_start_paused,
            media_start_with_embed, CC.MEDIA_VIEWER_ACTION_SHOW_WITH_NATIVE,
            preview_start_paused, preview_start_with_embed, image_zoom_info)

        media_view[HC.GENERAL_ANIMATION] = (video_action, media_start_paused,
                                            media_start_with_embed,
                                            video_action, preview_start_paused,
                                            preview_start_with_embed,
                                            gif_zoom_info)

        media_view[HC.GENERAL_VIDEO] = (video_action, media_start_paused,
                                        media_start_with_embed, video_action,
                                        preview_start_paused,
                                        preview_start_with_embed,
                                        video_zoom_info)

        media_view[HC.GENERAL_AUDIO] = (audio_action, media_start_paused,
                                        media_start_with_embed, audio_action,
                                        preview_start_paused,
                                        preview_start_with_embed,
                                        null_zoom_info)

        media_view[HC.GENERAL_APPLICATION] = (
            CC.MEDIA_VIEWER_ACTION_SHOW_OPEN_EXTERNALLY_BUTTON,
            media_start_paused, media_start_with_embed,
            CC.MEDIA_VIEWER_ACTION_SHOW_OPEN_EXTERNALLY_BUTTON,
            preview_start_paused, preview_start_with_embed, null_zoom_info)
    ...
    def _GetMediaViewOptions(self, mime):
        ...
        if mime in self._dictionary['media_view']:
            ...
            if mime not in HC.mimes_to_general_mimetypes:
                ...
                null_result = (CC.MEDIA_VIEWER_ACTION_DO_NOT_SHOW, False,
                               False, CC.MEDIA_VIEWER_ACTION_DO_NOT_SHOW,
                               False, False, (CC.MEDIA_VIEWER_SCALE_100,
                                              CC.MEDIA_VIEWER_SCALE_100,
                                              CC.MEDIA_VIEWER_SCALE_100,
                                              CC.MEDIA_VIEWER_SCALE_100, False,
                                              CC.ZOOM_LINEAR, CC.ZOOM_LINEAR))
            ...
            if general_mime_type not in self._dictionary['media_view']:
                ...
                self._dictionary[
                    'media_view'] = self._GetDefaultMediaViewOptions()
    ...
    def _InitialiseDefaults(self):
        ...
        self._dictionary['booleans'][
            'apply_all_parents_to_all_services'] = False
        self._dictionary['booleans'][
            'apply_all_siblings_to_all_services'] = False
        self._dictionary['booleans'][
        ...
        self._dictionary['booleans'][
            'hide_message_manager_on_gui_iconise'] = HC.PLATFORM_MACOS
        self._dictionary['booleans'][
            'hide_message_manager_on_gui_deactive'] = False
        ...
        self._dictionary['booleans'][
            'reverse_page_shift_drag_behaviour'] = False
        ...
        self._dictionary['booleans'][
            'autocomplete_results_fetch_automatically'] = True
        ...
        self._dictionary[
            'colours'] = HydrusSerialisable.SerialisableDictionary()

        self._dictionary['colours'][
            'default'] = HydrusSerialisable.SerialisableDictionary()

        self._dictionary['colours']['default'][CC.COLOUR_THUMB_BACKGROUND] = (
            255, 255, 255)
        self._dictionary['colours']['default'][
            CC.COLOUR_THUMB_BACKGROUND_SELECTED] = (217, 242, 255
                                                    )  # light blue
        self._dictionary['colours']['default'][
            CC.COLOUR_THUMB_BACKGROUND_REMOTE] = (32, 32, 36
                                                  )  # 50% Payne's Gray
        self._dictionary['colours']['default'][
            CC.COLOUR_THUMB_BACKGROUND_REMOTE_SELECTED] = (64, 64, 72
                                                           )  # Payne's Gray
        self._dictionary['colours']['default'][CC.COLOUR_THUMB_BORDER] = (
            223, 227, 230)  # light grey
        self._dictionary['colours']['default'][
            CC.COLOUR_THUMB_BORDER_SELECTED] = (1, 17, 26)  # dark grey
        self._dictionary['colours']['default'][
            CC.COLOUR_THUMB_BORDER_REMOTE] = (248, 208, 204
                                              )  # 25% Vermillion, 75% White
        self._dictionary['colours']['default'][
            CC.COLOUR_THUMB_BORDER_REMOTE_SELECTED] = (227, 66, 52
                                                       )  # Vermillion, lol
        self._dictionary['colours']['default'][
            CC.COLOUR_THUMBGRID_BACKGROUND] = (255, 255, 255)
        self._dictionary['colours']['default'][
            CC.COLOUR_AUTOCOMPLETE_BACKGROUND] = (235, 248, 255
                                                  )  # very light blue
        self._dictionary['colours']['default'][CC.COLOUR_MEDIA_BACKGROUND] = (
            255, 255, 255)
        self._dictionary['colours']['default'][CC.COLOUR_MEDIA_TEXT] = (0, 0,
                                                                        0)
        self._dictionary['colours']['default'][CC.COLOUR_TAGS_BOX] = (255, 255,
                                                                      255)

        self._dictionary['colours'][
            'darkmode'] = HydrusSerialisable.SerialisableDictionary()

        self._dictionary['colours']['darkmode'][CC.COLOUR_THUMB_BACKGROUND] = (
            64, 64, 72)  # Payne's Gray
        self._dictionary['colours']['darkmode'][
            CC.COLOUR_THUMB_BACKGROUND_SELECTED] = (112, 128, 144
                                                    )  # Slate Gray
        self._dictionary['colours']['darkmode'][
            CC.COLOUR_THUMB_BACKGROUND_REMOTE] = (64, 13, 2)  # Black Bean
        self._dictionary['colours']['darkmode'][
            CC.COLOUR_THUMB_BACKGROUND_REMOTE_SELECTED] = (171, 39, 79
                                                           )  # Amaranth Purple
        self._dictionary['colours']['darkmode'][CC.COLOUR_THUMB_BORDER] = (
            145, 163, 176)  # Cadet Grey
        self._dictionary['colours']['darkmode'][
            CC.COLOUR_THUMB_BORDER_SELECTED] = (223, 227, 230)  # light grey
        self._dictionary['colours']['darkmode'][
            CC.COLOUR_THUMB_BORDER_REMOTE] = (248, 208, 204
                                              )  # 25% Vermillion, 75% White
        self._dictionary['colours']['darkmode'][
        ...
        self._dictionary['colours']['darkmode'][
            CC.COLOUR_THUMBGRID_BACKGROUND] = (52, 52, 52)  # 20% flat gray
        self._dictionary['colours']['darkmode'][
            CC.COLOUR_AUTOCOMPLETE_BACKGROUND] = (83, 98, 103)  # Gunmetal
        self._dictionary['colours']['darkmode'][CC.COLOUR_MEDIA_BACKGROUND] = (
            52, 52, 52)  # 20% flat gray
        self._dictionary['colours']['darkmode'][CC.COLOUR_MEDIA_TEXT] = (
            112, 128, 144)  # Slate Gray
        self._dictionary['colours']['darkmode'][CC.COLOUR_TAGS_BOX] = (35, 38,
                                                                       41)

        #

        self._dictionary[
            'duplicate_action_options'] = HydrusSerialisable.SerialisableDictionary(
            )

        from . import ClientTags

        self._dictionary['duplicate_action_options'][
            HC.DUPLICATE_BETTER] = ClientDuplicates.DuplicateActionOptions(
                [(CC.DEFAULT_LOCAL_TAG_SERVICE_KEY,
                  HC.CONTENT_MERGE_ACTION_MOVE, ClientTags.TagFilter())], [],
                sync_archive=True,
                sync_urls_action=HC.CONTENT_MERGE_ACTION_COPY)
        self._dictionary['duplicate_action_options'][
            HC.
            DUPLICATE_SAME_QUALITY] = ClientDuplicates.DuplicateActionOptions(
                [(CC.DEFAULT_LOCAL_TAG_SERVICE_KEY,
        ...
        self._dictionary['duplicate_action_options'][
            HC.DUPLICATE_ALTERNATE] = ClientDuplicates.DuplicateActionOptions(
            )
        ...
        self._dictionary['keys']['default_gug_key'] = HydrusData.GenerateKey(
        ).hex()
        ...
        self._dictionary['noneable_integers'][
            'autocomplete_exact_match_threshold'] = 2
        ...
        self._dictionary[
            'simple_downloader_formulae'] = HydrusSerialisable.SerialisableList(
            )
        ...
        self._dictionary['string_list']['advanced_file_deletion_reasons'] = [
            'I do not like it.', 'It is bad quality.',
        ...
        self._dictionary[
            'favourite_tag_filters'] = HydrusSerialisable.SerialisableDictionary(
            )

        #

        self._dictionary[
            'tag_summary_generators'] = HydrusSerialisable.SerialisableDictionary(
            )
        ...
        tsg = ClientGUITags.TagSummaryGenerator(namespace_info=namespace_info,
                                                separator=separator,
        ...
        self._dictionary['tag_summary_generators'][
            'thumbnail_bottom_right'] = tsg
        ...
        example_tags = HydrusTags.CleanTags([
            'creator:creator', 'series:series', 'title:title', 'volume:1',
            'chapter:1', 'page:1'
        ])
        ...
        self._dictionary[
            'default_file_import_options'] = HydrusSerialisable.SerialisableDictionary(
            )
        ...
        quiet_file_import_options.SetPreImportOptions(
        ...
        quiet_file_import_options.SetPresentationOptions(
            present_new_files, present_already_in_inbox_files,
            present_already_in_archive_files)

        self._dictionary['default_file_import_options'][
            'quiet'] = quiet_file_import_options
        ...
        loud_file_import_options.SetPreImportOptions(
            exclude_deleted, do_not_check_known_urls_before_importing,
            do_not_check_hashes_before_importing, allow_decompression_bombs,
            min_size, max_size, max_gif_size, min_resolution, max_resolution)
        loud_file_import_options.SetPostImportOptions(automatic_archive,
                                                      associate_source_urls)
        loud_file_import_options.SetPresentationOptions(
            present_new_files, present_already_in_inbox_files,
            present_already_in_archive_files)

        self._dictionary['default_file_import_options'][
            'loud'] = loud_file_import_options
        ...
        self._dictionary['frame_locations']['file_import_status'] = (
            True, True, None, None, (-1, -1), 'topleft', False, False)
        self._dictionary['frame_locations']['gallery_import_log'] = (
            True, True, None, None, (-1, -1), 'topleft', False, False)
        self._dictionary['frame_locations'][
            'local_import_filename_tagging'] = (True, False, None, None, (-1,
                                                                          -1),
                                                'topleft', False, False)
        self._dictionary['frame_locations']['main_gui'] = (True, True, (800,
                                                                        600),
                                                           (20, 20), (-1, -1),
                                                           'topleft', True,
                                                           False)
        self._dictionary['frame_locations']['manage_options_dialog'] = (
            False, False, None, None, (-1, -1), 'topleft', False, False)
        self._dictionary['frame_locations']['manage_subscriptions_dialog'] = (
            True, True, None, None, (1, -1), 'topleft', False, False)
        self._dictionary['frame_locations']['edit_subscription_dialog'] = (
            True, True, None, None, (1, -1), 'topleft', False, False)
        self._dictionary['frame_locations']['manage_tags_dialog'] = (False,
                                                                     False,
                                                                     None,
                                                                     None, (-1,
                                                                            1),
                                                                     ...
                                                                     False,
                                                                     False)
        self._dictionary['frame_locations']['manage_tags_frame'] = (False,
                                                                    False,
                                                                    None, None,
                                                                    (-1, 1),
                                                                    'topleft',
                                                                    False,
                                                                    False)
        self._dictionary['frame_locations']['media_viewer'] = (True, True,
                                                               (640,
                                                                480), (70, 70),
                                                               (-1,
                                                                -1), 'topleft',
                                                               True, True)
        self._dictionary['frame_locations']['regular_dialog'] = (False, False,
                                                                 None, None,
                                                                 (-1, -1),
                                                                 'topleft',
                                                                 False, False)
        self._dictionary['frame_locations']['review_services'] = (False, True,
                                                                  None, None,
                                                                  (-1, -1),
                                                                  'topleft',
                                                                  False, False)
        self._dictionary['frame_locations']['deeply_nested_dialog'] = (
            False, False, None, None, (-1, -1), 'topleft', False, False)
        self._dictionary['frame_locations']['regular_center_dialog'] = (
            False, False, None, None, (-1, -1), 'center', False, False)

        #

        self._dictionary[
            'media_launch'] = HydrusSerialisable.SerialisableDictionary(
            )  # integer keys, so got to be cleverer dict
        ...
        self._dictionary['media_zooms'] = [
            0.01, 0.05, 0.1, 0.15, 0.2, 0.3, 0.5, 0.7, 0.8, 0.9, 1.0, 1.1, 1.2,
            1.5, 2.0, 3.0, 5.0, 10.0, 20.0
        ]
        ...
        self._dictionary['misc'][
            'default_thread_watcher_options'] = ClientDefaults.GetDefaultCheckerOptions(
                'thread')
        self._dictionary['misc'][
            'default_subscription_checker_options'] = ClientDefaults.GetDefaultCheckerOptions(
                'artist subscription')

        #

        self._dictionary[
            'suggested_tags'] = HydrusSerialisable.SerialisableDictionary()
        ...
        self._dictionary['default_sort'] = ClientMedia.MediaSort(
            ('system', CC.SORT_FILES_BY_FILESIZE), CC.SORT_ASC)
        self._dictionary['fallback_sort'] = ClientMedia.MediaSort(
    ...
    def _InitialiseFromSerialisableInfo(self, serialisable_info):
        ...
        loaded_dictionary = HydrusSerialisable.CreateFromSerialisableTuple(
            serialisable_info)

        for (key, value) in list(loaded_dictionary.items()):

            if key in self._dictionary and isinstance(
                    self._dictionary[key], dict) and isinstance(value, dict):
    ...
    def _UpdateSerialisableInfo(self, version, old_serialisable_info):
            ...
            if 'media_view' in loaded_dictionary:
                ...
                for mime in mimes:
                    ...
                    if mime in self._dictionary['media_view']:
                        ...
                        (default_media_show_action,
                         default_preview_show_action, default_zoom_info
                         ) = self._dictionary['media_view'][mime]

                        (media_show_action, preview_show_action,
                         zoom_in_to_fit, exact_zooms_only, scale_up_quality,
                         scale_down_quality
        ...
        if version == 2:
            ...
            def update_portable_path(p):
                ...
                p = os.path.normpath(
                    p
                )  # collapses .. stuff and converts / to \\ for windows only
                ...
                if HC.PLATFORM_WINDOWS:
                    ...
                    p = p.replace(
                        '\\', '/'
                    )  # store seps as /, to maintain multiplatform uniformity
            ...
            if 'client_files_locations_ideal_weights' in loaded_dictionary:
                ...
                for (
                        old_portable_path, weight
                ) in loaded_dictionary['client_files_locations_ideal_weights']:
                ...
                loaded_dictionary[
                    'client_files_locations_ideal_weights'] = updated_cfliw

            if 'client_files_locations_resized_thumbnail_override' in loaded_dictionary:

                loaded_dictionary[
                    'client_files_locations_resized_thumbnail_override'] = update_portable_path(
                        loaded_dictionary[
                            'client_files_locations_resized_thumbnail_override']
                    )

            if 'client_files_locations_full_size_thumbnail_override' in loaded_dictionary:

                loaded_dictionary[
                    'client_files_locations_full_size_thumbnail_override'] = update_portable_path(
                        loaded_dictionary[
        ...
        if version == 3:
            ...
            if 'media_view' in loaded_dictionary:
                ...
                def convert_show_action(show_action):
                    ...
                    start_paused = show_action in (
                        CC.MEDIA_VIEWER_ACTION_SHOW_BEHIND_EMBED_PAUSED,
                        CC.MEDIA_VIEWER_ACTION_SHOW_WITH_NATIVE_PAUSED)
                    start_with_embed = show_action in (
                        CC.MEDIA_VIEWER_ACTION_SHOW_BEHIND_EMBED,
                        CC.MEDIA_VIEWER_ACTION_SHOW_BEHIND_EMBED_PAUSED)
                ...
                for (mime, (media_show_action, preview_show_action,
                            zoom_info)) in list(
                                loaded_dictionary['media_view'].items()):

                    (media_show_action, media_start_paused,
                     media_start_with_embed
                     ) = convert_show_action(media_show_action)
                    (preview_show_action, preview_start_paused,
                     preview_start_with_embed
                     ) = convert_show_action(preview_show_action)
    ...
    def FlipBoolean(self, name):
        ...
        with self._lock:
            ...
            self._dictionary['booleans'][
                name] = not self._dictionary['booleans'][name]
    ...
    def GetDefaultFileImportOptions(self, options_type):
        ...
        with self._lock:
            ...
            return self._dictionary['default_file_import_options'][
                options_type]
    ...
    def GetDuplicateActionOptions(self, duplicate_type):
        ...
        with self._lock:
            ...
            if duplicate_type in self._dictionary['duplicate_action_options']:
                ...
                return self._dictionary['duplicate_action_options'][
                    duplicate_type]
    ...
    def GetKeyList(self, name):
        ...
        with self._lock:
            ...
            return [
                ...
                for hex_key in self._dictionary['key_list'][name]
            ]
    ...
    def GetMediaShowAction(self, mime):
        ...
        with self._lock:
            ...
            (media_show_action, media_start_paused, media_start_with_embed,
             preview_show_action, preview_start_paused,
             preview_start_with_embed,
             zoom_info) = self._GetMediaViewOptions(mime)

            (possible_show_actions, can_start_paused,
             can_start_with_embed) = CC.media_viewer_capabilities[mime]
            ...
            return (media_show_action, media_start_paused,
                    media_start_with_embed)
    ...
    def GetPreviewShowAction(self, mime):
        ...
        with self._lock:
            ...
            return (preview_show_action, preview_start_paused,
                    preview_start_with_embed)
    ...
    def SetDefaultFileImportOptions(self, options_type, file_import_options):
        ...
        with self._lock:
            ...
            self._dictionary['default_file_import_options'][
                options_type] = file_import_options
    ...
    def SetDefaultSubscriptionCheckerOptions(self, checker_options):
        ...
        with self._lock:
            ...
            self._dictionary['misc'][
                'default_subscription_checker_options'] = checker_options
    ...
    def SetDefaultWatcherCheckerOptions(self, checker_options):
        ...
        with self._lock:
            ...
            self._dictionary['misc'][
                'default_thread_watcher_options'] = checker_options

    def SetDuplicateActionOptions(self, duplicate_type,
    ...
    def SetFrameLocation(self, frame_key, remember_size, remember_position,
                         last_size, last_position, default_gravity,
                         default_position, maximised, fullscreen):

        with self._lock:

            self._dictionary['frame_locations'][frame_key] = (
                remember_size, remember_position, last_size, last_position,
                default_gravity, default_position, maximised, fullscreen)
    ...
    def SetTagSummaryGenerator(self, name, tag_summary_generator):
        ...
        with self._lock:
            ...
            self._dictionary['tag_summary_generators'][
                name] = tag_summary_generator


HydrusSerialisable.SERIALISABLE_TYPES_TO_OBJECT_TYPES[
    HydrusSerialisable.SERIALISABLE_TYPE_CLIENT_OPTIONS] = ClientOptions
