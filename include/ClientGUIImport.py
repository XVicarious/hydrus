...
from . import (ClientDefaults, ClientDownloading, ClientGUIACDropdown,
               ...
               ClientGUIFunctions, ClientGUIGallerySeedLog, ClientGUIListBoxes,
               ClientGUIListCtrl, ClientGUIMenus, ClientGUIOptionsPanels,
               ClientGUIScrolledPanels, ClientGUIScrolledPanelsEdit,
               ClientGUIShortcuts, ClientGUITime, ClientGUITopLevelWindows,
               ClientImportFileSeeds, ClientImportGallerySeeds,
...
class CheckerOptionsButton(ClientGUICommon.BetterButton):
    def __init__(self, parent, checker_options, update_callable=None):
        ...
        ClientGUICommon.BetterButton.__init__(self, parent, 'checker options',
                                              self._EditOptions)
    ...
    def _EditOptions(self):
        ...
        with ClientGUITopLevelWindows.DialogEdit(
                self, 'edit checker options') as dlg:

            panel = ClientGUITime.EditCheckerOptions(dlg,
...
class FileImportOptionsButton(ClientGUICommon.BetterButton):
    def __init__(self,
        ...
        ClientGUICommon.BetterButton.__init__(self, parent,
                                              'file import options',
                                              self._EditOptions)
    ...
    def _EditOptions(self):
        ...
        with ClientGUITopLevelWindows.DialogEdit(
                self, 'edit file import options') as dlg:

            panel = ClientGUIScrolledPanelsEdit.EditFileImportOptions(
                dlg, self._file_import_options, self._show_downloader_options)
...
class FilenameTaggingOptionsPanel(QW.QWidget):
    def __init__(self,
                 ...
                 service_key,
                 tag_update_callable,
                 filename_tagging_options=None,
                 present_for_accompanying_file_list=False):
        ...
        self._simple_panel = self._SimplePanel(
            self._notebook, self._service_key, tag_update_callable,
            filename_tagging_options, present_for_accompanying_file_list)
        self._advanced_panel = self._AdvancedPanel(
            self._notebook, self._service_key, tag_update_callable,
            filename_tagging_options, present_for_accompanying_file_list)
    ...
    def GetFilenameTaggingOptions(self):
        ...
        self._advanced_panel.UpdateFilenameTaggingOptions(
            filename_tagging_options)
        self._simple_panel.UpdateFilenameTaggingOptions(
            filename_tagging_options)
    ...
    def GetTags(self, index, path):
        ...
        tags = HG.client_controller.tag_display_manager.FilterTags(
            ClientTags.TAG_DISPLAY_STORAGE, self._service_key, tags)
    ...
    class _AdvancedPanel(QW.QWidget):
        def __init__(self, parent, service_key, refresh_callable,
            ...
            quick_namespaces_listctrl_panel = ClientGUIListCtrl.BetterListCtrlPanel(
            ...
            quick_namespaces_listctrl_panel.SetListCtrl(
                self._quick_namespaces_list)

            quick_namespaces_listctrl_panel.AddButton('add',
                                                      self.AddQuickNamespace)
            quick_namespaces_listctrl_panel.AddButton(
                'edit',
            ...
            self._num_base = QP.MakeQSpinBox(self._num_panel,
                                             min=-10000000,
                                             max=10000000,
                                             width=60)
            ...
            self._num_step = QP.MakeQSpinBox(self._num_panel,
                                             min=-1000000,
                                             max=1000000,
                                             width=60)
            ...
            self._num_namespace.textChanged.connect(
            ...
            self._quick_namespaces_panel.Add(quick_namespaces_listctrl_panel,
            ...
            QP.AddToLayout(hbox, QW.QLabel('# base/step: ', self._num_panel),
                           CC.FLAGS_VCENTER)
            ...
            QP.AddToLayout(hbox, QW.QLabel('# namespace: ', self._num_panel),
                           CC.FLAGS_VCENTER)
            QP.AddToLayout(hbox, self._num_namespace,
                           CC.FLAGS_EXPAND_BOTH_WAYS)
            ...
            QP.AddToLayout(second_vbox, self._regexes_panel,
                           CC.FLAGS_EXPAND_BOTH_WAYS)
            QP.AddToLayout(second_vbox, self._num_panel,
                           CC.FLAGS_EXPAND_PERPENDICULAR)
            ...
            QP.AddToLayout(hbox, self._quick_namespaces_panel,
                           CC.FLAGS_EXPAND_BOTH_WAYS)
        ...
        def EditQuickNamespaces(self):
            ...
            data_to_edit = self._quick_namespaces_list.GetData(
                only_selected=True)
            ...
            for old_data in data_to_edit:
                ...
                with ClientGUIDialogs.DialogInputNamespaceRegex(
                        self, namespace=namespace, regex=regex) as dlg:
                    ...
                    if dlg.exec() == QW.QDialog.Accepted:
                        ...
                        if new_data != old_data:
                            ...
                            self._quick_namespaces_list.DeleteDatas(
                                (old_data, ))
        ...
        def EventRemoveRegex(self, item):
            ...
            if selection != -1:
                ...
                if len(self._regex_box.text()) == 0:
                    ...
                    self._regex_box.setText(
                        self._regexes.item(selection).text())
        ...
        def UpdateFilenameTaggingOptions(self, filename_tagging_options):
            ...
            filename_tagging_options.AdvancedSetTuple(quick_namespaces,
                                                      regexes)
    ...
    class _SimplePanel(QW.QWidget):
        def __init__(self, parent, service_key, refresh_callable,
            ...
            self._load_from_txt_files_checkbox = QW.QCheckBox(
                'try to load tags from neighbouring .txt files',
                self._checkboxes_panel)

            txt_files_help_button = ClientGUICommon.BetterBitmapButton(
                self._checkboxes_panel, CC.GlobalPixmaps.help,
                self._ShowTXTHelp)
            ...
            self._filename_checkbox = QW.QCheckBox('add filename? [namespace]',
                                                   self._checkboxes_panel)
            ...
            for (index, phrase) in directory_items:
                ...
                dir_checkbox = QW.QCheckBox(
                    'add ' + phrase + ' directory? [namespace]',
                    self._checkboxes_panel)

                dir_namespace_textctrl = QW.QLineEdit(self._checkboxes_panel)
                dir_namespace_textctrl.setMinimumWidth(100)

                self._directory_namespace_controls[index] = (
                    dir_checkbox, dir_namespace_textctrl)

            #

            (tags_for_all, load_from_neighbouring_txt_files, add_filename,
             directory_dict) = filename_tagging_options.SimpleToTuple()

            self._tags.AddTags(tags_for_all)
            self._load_from_txt_files_checkbox.setChecked(
            ...
            for (index, (dir_boolean,
                         dir_namespace)) in list(directory_dict.items()):
            ...
            QP.AddToLayout(txt_hbox, self._load_from_txt_files_checkbox,
                           CC.FLAGS_EXPAND_BOTH_WAYS)
            QP.AddToLayout(txt_hbox, txt_files_help_button, CC.FLAGS_VCENTER)

            filename_hbox = QP.HBoxLayout()

            QP.AddToLayout(filename_hbox, self._filename_checkbox,
                           CC.FLAGS_VCENTER)
            QP.AddToLayout(filename_hbox, self._filename_namespace,
                           CC.FLAGS_EXPAND_BOTH_WAYS)
            ...
            for index in (0, 1, 2, -3, -2, -1):
                ...
                QP.AddToLayout(hbox, dir_namespace_textctrl,
                               CC.FLAGS_EXPAND_BOTH_WAYS)

                self._checkboxes_panel.Add(hbox,
                                           CC.FLAGS_EXPAND_SIZER_PERPENDICULAR)

            self._checkboxes_panel.Add(QW.QWidget(self._checkboxes_panel),
                                       CC.FLAGS_EXPAND_BOTH_WAYS)

            hbox = QP.HBoxLayout()

            QP.AddToLayout(hbox, self._tags_panel, CC.FLAGS_EXPAND_BOTH_WAYS)
            QP.AddToLayout(hbox, self._single_tags_panel,
                           CC.FLAGS_EXPAND_BOTH_WAYS)
            QP.AddToLayout(hbox, self._checkboxes_panel,
                           CC.FLAGS_EXPAND_PERPENDICULAR)
            ...
            self._load_from_txt_files_checkbox.clicked.connect(
                self.EventRefresh)
        ...
        def EnterTags(self, tags):
            ...
            HG.client_controller.Write('push_recent_tags', self._service_key,
                                       tags)
        ...
        def UpdateFilenameTaggingOptions(self, filename_tagging_options):
            ...
            add_filename = (self._filename_checkbox.isChecked(),
                            self._filename_namespace.text())

            directories_dict = {}

            for (index, (dir_checkbox, dir_namespace_textctrl)
                 ) in self._directory_namespace_controls.items():

                directories_dict[index] = (dir_checkbox.isChecked(),
                                           dir_namespace_textctrl.text())

            filename_tagging_options.SimpleSetTuple(
                tags_for_all, load_from_neighbouring_txt_files, add_filename,
                directories_dict)
...
class EditImportFoldersPanel(ClientGUIScrolledPanels.EditPanel):
    def __init__(self, parent, import_folders):
        ...
        columns = [('name', 24), ('path', -1), ('paused', 8),
                   ('check period', 24)]

        self._import_folders = ClientGUIListCtrl.BetterListCtrl(
            import_folders_panel,
            'import_folders',
            8,
            36,
            columns,
            self._ConvertImportFolderToListCtrlTuples,
            use_simple_delete=True,
        ...
        import_folders_panel.AddButton('edit',
                                       self._Edit,
                                       enabled_only_on_selection=True)
    ...
    def _ConvertImportFolderToListCtrlTuples(self, import_folder):
        ...
        (name, path, paused, check_regularly,
         check_period) = import_folder.ToListBoxTuple()
        ...
        if not check_regularly:
            ...
            pretty_check_period = HydrusData.TimeDeltaToPrettyTimeDelta(
                check_period)
    ...
    def _Edit(self):
        ...
        for import_folder in import_folders:
            ...
            with ClientGUITopLevelWindows.DialogEdit(
                    self, 'edit import folder') as dlg:
                ...
                if dlg.exec() == QW.QDialog.Accepted:
                    ...
                    edited_import_folder.SetNonDupeName(
...
class EditImportFolderPanel(ClientGUIScrolledPanels.EditPanel):
    def __init__(self, parent, import_folder):
        ...
        (name, path, mimes, file_import_options, tag_import_options,
         ...
         publish_files_to_page) = self._import_folder.ToTuple()
        ...
        self._period = ClientGUITime.TimeDeltaButton(self._folder_box,
                                                     min=3 * 60,
                                                     days=True,
                                                     hours=True,
                                                     minutes=True)
        ...
        self._file_seed_cache_button = ClientGUIFileSeedCache.FileSeedCacheButton(
            self._folder_box,
            HG.client_controller,
            self._import_folder.GetFileSeedCache,
            file_seed_cache_set_callable=self._import_folder.SetFileSeedCache)

        #

        self._file_box = ClientGUICommon.StaticBox(self, 'file options')

        self._mimes = ClientGUIOptionsPanels.OptionsPanelMimes(
            self._file_box, HC.ALLOWED_MIMES)

        def create_choice():

            choice = ClientGUICommon.BetterChoice(self._file_box)

            for if_id in (CC.IMPORT_FOLDER_DELETE, CC.IMPORT_FOLDER_IGNORE,
                          CC.IMPORT_FOLDER_MOVE):
        ...
        self._file_import_options = FileImportOptionsButton(
            self._file_box, file_import_options, show_downloader_options)

        #

        self._tag_box = ClientGUICommon.StaticBox(self, 'tag options')

        self._tag_import_options = TagImportOptionsButton(
            self._tag_box, tag_import_options, show_downloader_options)

        self._filename_tagging_options_box = ClientGUICommon.StaticBox(
            self._tag_box, 'filename tagging')

        filename_tagging_options_panel = ClientGUIListCtrl.BetterListCtrlPanel(
            self._filename_tagging_options_box)

        columns = [('filename tagging options services', -1)]

        self._filename_tagging_options = ClientGUIListCtrl.BetterListCtrl(
            filename_tagging_options_panel,
            'filename_tagging_options',
            5,
            25,
            columns,
            self._ConvertFilenameTaggingOptionsToListCtrlTuples,
            use_simple_delete=True,
            activation_callback=self._EditFilenameTaggingOptions)

        filename_tagging_options_panel.SetListCtrl(
            self._filename_tagging_options)

        filename_tagging_options_panel.AddButton(
            'add', self._AddFilenameTaggingOptions)
        filename_tagging_options_panel.AddButton(
            'edit',
            self._EditFilenameTaggingOptions,
            enabled_only_on_selection=True)
        ...
        if CC.STATUS_SUCCESSFUL_AND_NEW in action_locations:
            ...
            self._location_successful.SetPath(
                action_locations[CC.STATUS_SUCCESSFUL_AND_NEW])

        self._action_redundant.SetValue(
            actions[CC.STATUS_SUCCESSFUL_BUT_REDUNDANT])
        if CC.STATUS_SUCCESSFUL_BUT_REDUNDANT in action_locations:

            self._location_redundant.SetPath(
                action_locations[CC.STATUS_SUCCESSFUL_BUT_REDUNDANT])
        ...
        good_tag_service_keys_to_filename_tagging_options = {
        ...
        self._filename_tagging_options.AddDatas(
            list(good_tag_service_keys_to_filename_tagging_options.items()))
        ...
        rows.append(('currently paused (if set, will not ever do any work): ',
                     self._paused))
        ...
        rows.append(('review currently cached import paths: ',
                     self._file_seed_cache_button))
        ...
        mimes_gridbox = ClientGUICommon.WrapInGrid(self._file_box,
                                                   rows,
                                                   expand_text=True)
        ...
        QP.AddToLayout(
            gridbox,
            QW.QLabel('when a file imports successfully: ', self._file_box),
            CC.FLAGS_VCENTER)
        QP.AddToLayout(gridbox, self._action_successful,
                       CC.FLAGS_EXPAND_BOTH_WAYS)
        QP.AddToLayout(gridbox, self._location_successful,
                       CC.FLAGS_EXPAND_BOTH_WAYS)

        QP.AddToLayout(
            gridbox,
            QW.QLabel('when a file is already in the db: ', self._file_box),
            CC.FLAGS_VCENTER)
        QP.AddToLayout(gridbox, self._action_redundant,
                       CC.FLAGS_EXPAND_BOTH_WAYS)
        QP.AddToLayout(gridbox, self._location_redundant,
                       CC.FLAGS_EXPAND_BOTH_WAYS)

        QP.AddToLayout(
            gridbox,
            QW.QLabel('when a file has previously been deleted from the db: ',
                      self._file_box), CC.FLAGS_VCENTER)
        QP.AddToLayout(gridbox, self._action_deleted,
                       CC.FLAGS_EXPAND_BOTH_WAYS)
        QP.AddToLayout(gridbox, self._location_deleted,
                       CC.FLAGS_EXPAND_BOTH_WAYS)

        QP.AddToLayout(
            gridbox, QW.QLabel('when a file fails to import: ',
                               self._file_box), CC.FLAGS_VCENTER)
        QP.AddToLayout(gridbox, self._action_failed, CC.FLAGS_EXPAND_BOTH_WAYS)
        QP.AddToLayout(gridbox, self._location_failed,
                       CC.FLAGS_EXPAND_BOTH_WAYS)
        ...
        self._file_box.Add(self._file_import_options,
                           CC.FLAGS_EXPAND_PERPENDICULAR)

        #

        self._filename_tagging_options_box.Add(filename_tagging_options_panel,
                                               CC.FLAGS_EXPAND_BOTH_WAYS)

        self._tag_box.Add(self._tag_import_options,
                          CC.FLAGS_EXPAND_PERPENDICULAR)
        self._tag_box.Add(self._filename_tagging_options_box,
                          CC.FLAGS_EXPAND_BOTH_WAYS)
    ...
    def _AddFilenameTaggingOptions(self):
        ...
        existing_service_keys = {
            service_key
            for (service_key, filename_tagging_options
                 ) in self._filename_tagging_options.GetData()
        }
        ...
        with ClientGUITopLevelWindows.DialogEdit(
                self, 'edit filename tagging options') as dlg:

            filename_tagging_options = ClientImportOptions.FilenameTaggingOptions(
            )

            panel = EditFilenameTaggingOptionPanel(dlg, service_key,
                                                   filename_tagging_options)
    ...
    def _CheckValid(self):
        ...
        if not os.path.exists(path):
            ...
            QW.QMessageBox.warning(
                self, 'Warning', 'The path you have entered--"' + path +
                '"--does not exist! The dialog will not force you to correct it, but this import folder will do no work as long as the location is missing!'
            )

        if HC.BASE_DIR.startswith(
                path) or HG.client_controller.GetDBDir().startswith(path):

            raise HydrusExceptions.VetoException(
                'You cannot set an import path that includes your install or database directory!'
            )
        ...
        if self._action_successful.GetValue() == CC.IMPORT_FOLDER_MOVE:
            ...
            if not os.path.exists(path):
                ...
                QW.QMessageBox.warning(
                    self, 'Warning',
                    'The path you have entered for your successful file move location--"'
                    + path +
                    '"--does not exist! The dialog will not force you to correct it, but you should not let this import folder run until you have corrected or created it!'
                )
        ...
        if self._action_redundant.GetValue() == CC.IMPORT_FOLDER_MOVE:
            ...
            if path in ('', None):
                ...
                raise HydrusExceptions.VetoException(
                    'You must enter a path for your redundant file move location!'
                )
            ...
            if not os.path.exists(path):
                ...
                QW.QMessageBox.warning(
                    self, 'Warning',
                    'The path you have entered for your redundant file move location--"'
                    + path +
                    '"--does not exist! The dialog will not force you to correct it, but you should not let this import folder run until you have corrected or created it!'
                )
        ...
        if self._action_deleted.GetValue() == CC.IMPORT_FOLDER_MOVE:
            ...
            if path in ('', None):
                ...
                raise HydrusExceptions.VetoException(
                    'You must enter a path for your deleted file move location!'
                )
            ...
            if not os.path.exists(path):
                ...
                QW.QMessageBox.warning(
                    self, 'Warning',
                    'The path you have entered for your deleted file move location--"'
                    + path +
                    '"--does not exist! The dialog will not force you to correct it, but you should not let this import folder run until you have corrected or created it!'
                )
        ...
        if self._action_failed.GetValue() == CC.IMPORT_FOLDER_MOVE:
            ...
            if path in ('', None):
                ...
                raise HydrusExceptions.VetoException(
                    'You must enter a path for your failed file move location!'
                )
            ...
            if not os.path.exists(path):
                ...
                QW.QMessageBox.warning(
                    self, 'Warning',
                    'The path you have entered for your failed file move location--"'
                    + path +
                    '"--does not exist! The dialog will not force you to correct it, but you should not let this import folder run until you have corrected or created it!'
                )
    ...
    def _EditFilenameTaggingOptions(self):
        ...
        selected_data = self._filename_tagging_options.GetData(
            only_selected=True)
        ...
        for data in selected_data:
            ...
            with ClientGUITopLevelWindows.DialogEdit(
                ...
                panel = EditFilenameTaggingOptionPanel(
                    dlg, service_key, filename_tagging_options)
    ...
    def GetValue(self):
        ...
        actions[
            CC.STATUS_SUCCESSFUL_AND_NEW] = self._action_successful.GetValue()
        if actions[CC.STATUS_SUCCESSFUL_AND_NEW] == CC.IMPORT_FOLDER_MOVE:

            action_locations[
                CC.
                STATUS_SUCCESSFUL_AND_NEW] = self._location_successful.GetPath(
                )

        actions[
            CC.
            STATUS_SUCCESSFUL_BUT_REDUNDANT] = self._action_redundant.GetValue(
            )
        if actions[
                CC.STATUS_SUCCESSFUL_BUT_REDUNDANT] == CC.IMPORT_FOLDER_MOVE:

            action_locations[
                CC.
                STATUS_SUCCESSFUL_BUT_REDUNDANT] = self._location_redundant.GetPath(
                )
        ...
        if actions[CC.STATUS_DELETED] == CC.IMPORT_FOLDER_MOVE:
            ...
            action_locations[
                CC.STATUS_DELETED] = self._location_deleted.GetPath()
        ...
        tag_service_keys_to_filename_tagging_options = dict(
            self._filename_tagging_options.GetData())

        self._import_folder.SetTuple(
            name, path, mimes, file_import_options, tag_import_options,
            tag_service_keys_to_filename_tagging_options, actions,
            action_locations, period, check_regularly, paused, check_now,
            show_working_popup, publish_files_to_popup_button,
    ...
    class _Panel(QW.QWidget):
        def __init__(self, parent, service_key, paths):
            ...
            self._paths_list = ClientGUIListCtrl.BetterListCtrl(
                self, 'paths_to_tags', 10, 40, columns,
                self._ConvertDataToListCtrlTuples)

            self._paths_list.itemSelectionChanged.connect(
                self.EventItemSelected)

            #

            self._filename_tagging_panel = FilenameTaggingOptionsPanel(
                self,
                self._service_key,
                self.ScheduleRefreshFileList,
            ...
            QP.AddToLayout(vbox, self._filename_tagging_panel,
                           CC.FLAGS_EXPAND_PERPENDICULAR)
        ...
        def EventItemSelected(self):
            ...
            paths = [
                path for (index,
                          path) in self._paths_list.GetData(only_selected=True)
            ]
        ...
        def GetInfo(self):
            ...
            paths_to_tags = {
                path: self._GetTags(index, path)
                for (index, path) in self._paths_list.GetData()
            }
        ...
        def ScheduleRefreshFileList(self):
            ...
            self._schedule_refresh_file_list_job = HG.client_controller.CallLaterQtSafe(
                self, 0.5, self.RefreshFileList)
...
class EditFilenameTaggingOptionPanel(ClientGUIScrolledPanels.EditPanel):
    def __init__(self, parent, service_key, filename_tagging_options):
        ...
        self._filename_tagging_options_panel = FilenameTaggingOptionsPanel(
            self,
            self._service_key,
            self.ScheduleRefreshTags,
            filename_tagging_options=filename_tagging_options,
            present_for_accompanying_file_list=False)
        ...
        QP.AddToLayout(vbox, self._example_path_input,
                       CC.FLAGS_EXPAND_PERPENDICULAR)
        QP.AddToLayout(vbox, self._example_output,
                       CC.FLAGS_EXPAND_PERPENDICULAR)
        QP.AddToLayout(vbox, self._filename_tagging_options_panel,
                       CC.FLAGS_EXPAND_BOTH_WAYS)
    ...
    def RefreshTags(self):
        ...
        try:
            ...
            tags = filename_tagging_options.GetTags(self._service_key,
                                                    example_path_input)
    ...
    def ScheduleRefreshTags(self):
        ...
        self._schedule_refresh_tags_job = HG.client_controller.CallLaterQtSafe(
            self, 0.5, self.RefreshTags)
...
class GalleryImportPanel(ClientGUICommon.StaticBox):
    def __init__(self, parent, page_key, name='gallery query'):
        ...
        self._file_status = ClientGUICommon.BetterStaticText(
        ...
        self._file_seed_cache_control = ClientGUIFileSeedCache.FileSeedCacheStatusControl(
            self._import_queue_panel, HG.client_controller, self._page_key)
        self._file_download_control = ClientGUIControls.NetworkJobControl(
            self._import_queue_panel)

        self._files_pause_button = ClientGUICommon.BetterBitmapButton(
        ...
        self._gallery_status = ClientGUICommon.BetterStaticText(
            self._gallery_panel, ellipsize_end=True)

        self._gallery_pause_button = ClientGUICommon.BetterBitmapButton(
            self._gallery_panel, CC.GlobalPixmaps.gallery_pause,
            self.PauseGallery)
        ...
        self._file_limit = ClientGUICommon.NoneableSpinCtrl(
            self, 'stop after this many files', min=1, none_phrase='no limit')
        self._file_limit.valueChanged.connect(self.EventFileLimit)
        self._file_limit.setToolTip(
            'stop searching the gallery once this many files has been reached')
        ...
        self._file_import_options = FileImportOptionsButton(
            ...
            self._SetFileImportOptions)
        self._tag_import_options = TagImportOptionsButton(
            self,
            tag_import_options,
            show_downloader_options,
            update_callable=self._SetTagImportOptions,
        ...
        QP.AddToLayout(hbox, self._gallery_status,
        ...
        self._gallery_panel.Add(self._gallery_seed_log_control,
                                CC.FLAGS_EXPAND_PERPENDICULAR)
        self._gallery_panel.Add(self._gallery_download_control,
                                CC.FLAGS_EXPAND_PERPENDICULAR)
        ...
        QP.AddToLayout(hbox, self._file_status,
                       CC.FLAGS_VCENTER_EXPAND_DEPTH_ONLY)
    ...
    def _UpdateStatus(self):
        ...
        if self._gallery_import is not None:
            ...
            (gallery_status, file_status, files_paused,
             gallery_paused) = self._gallery_import.GetStatus()

            if files_paused:

                ClientGUIFunctions.SetBitmapButtonBitmap(
                    self._files_pause_button, CC.GlobalPixmaps.file_play)

            else:

                ClientGUIFunctions.SetBitmapButtonBitmap(
                    self._files_pause_button, CC.GlobalPixmaps.file_pause)

            if gallery_paused:

                ClientGUIFunctions.SetBitmapButtonBitmap(
                    self._gallery_pause_button, CC.GlobalPixmaps.gallery_play)

            else:

                ClientGUIFunctions.SetBitmapButtonBitmap(
                    self._gallery_pause_button, CC.GlobalPixmaps.gallery_pause)
            ...
            (file_network_job,
             gallery_network_job) = self._gallery_import.GetNetworkJobs()
...
class GUGKeyAndNameSelector(ClientGUICommon.BetterButton):
    def __init__(self, parent, gug_key_and_name, update_callable=None):
        ...
        ClientGUICommon.BetterButton.__init__(self, parent, 'gallery selector',
                                              self._Edit)

        gug = HG.client_controller.network_engine.domain_manager.GetGUG(
            gug_key_and_name)
    ...
    def _Edit(self):
        ...
        choice_tuples = [(gug.GetName(), gug) for gug in functional_gugs
                         if gug.GetGUGKey() in gug_keys_to_display]

        second_choice_tuples = [(gug.GetName(), gug) for gug in functional_gugs
                                if gug.GetGUGKey() not in gug_keys_to_display]
        ...
        if len(non_functional_gugs) > 0:
            ...
            non_functional_choice_tuples = [(gug.GetName(), gug)
        ...
        try:
            ...
            gug = ClientGUIDialogsQuick.SelectFromList(self,
                                                       'select gallery',
                                                       choice_tuples,
                                                       value_to_select=my_gug,
                                                       sort_tuples=False)
        ...
        if gug == -1:
            ...
            try:
                ...
                gug = ClientGUIDialogsQuick.SelectFromList(
                    self,
                    'select gallery',
                    second_choice_tuples,
                    value_to_select=my_gug,
                    sort_tuples=False)
...
class TagImportOptionsButton(ClientGUICommon.BetterButton):
    ...
    def _EditOptions(self):
        ...
        with ClientGUITopLevelWindows.DialogEdit(
            ...
            panel = ClientGUIScrolledPanelsEdit.EditTagImportOptionsPanel(
                dlg,
                self._tag_import_options,
                self._show_downloader_options,
                allow_default_selection=self._allow_default_selection)
    ...
    def _SetToolTip(self):
        ...
        summary = self._tag_import_options.GetSummary(
            self._show_downloader_options)
    ...
    def ShowMenu(self):
        ...
        ClientGUIMenus.AppendMenuItem(
            ...
            'Serialise this tag import options and copy it to clipboard.',
            self._Copy)

        ClientGUIMenus.AppendSeparator(menu)

        ClientGUIMenus.AppendMenuItem(
            menu, 'paste from clipboard',
            'Try to import serialised tag import options from the clipboard.',
            self._Paste)
        ...
        if not self._tag_import_options.IsDefault():
            ...
            ClientGUIMenus.AppendMenuItem(
                menu, 'set to default',
                'Set this tag import options to defer to the defaults.',
                self._SetDefault)
...
class WatcherReviewPanel(ClientGUICommon.StaticBox):
    def __init__(self, parent, page_key, name='watcher'):
        ...
        self._watcher_subject = ClientGUICommon.BetterStaticText(
        ...
        imports_panel = ClientGUICommon.StaticBox(self._options_panel,
                                                  'file imports')

        self._files_pause_button = ClientGUICommon.BetterBitmapButton(
            imports_panel, CC.GlobalPixmaps.file_pause, self.PauseFiles)
        self._files_pause_button.setToolTip('pause/play files')

        self._file_status = ClientGUICommon.BetterStaticText(
            imports_panel, ellipsize_end=True)
        self._file_seed_cache_control = ClientGUIFileSeedCache.FileSeedCacheStatusControl(
            imports_panel, HG.client_controller, self._page_key)
        self._file_download_control = ClientGUIControls.NetworkJobControl(
            imports_panel)

        #

        checker_panel = ClientGUICommon.StaticBox(self._options_panel,
                                                  'checker')

        self._file_velocity_status = ClientGUICommon.BetterStaticText(
            checker_panel, ellipsize_end=True)

        self._checking_pause_button = ClientGUICommon.BetterBitmapButton(
            checker_panel, CC.GlobalPixmaps.gallery_pause, self.PauseChecking)
        self._checking_pause_button.setToolTip('pause/play checking')

        self._watcher_status = ClientGUICommon.BetterStaticText(
            checker_panel, ellipsize_end=True)
        ...
        self._checker_options_button = CheckerOptionsButton(
            checker_panel,
            checker_options,
            update_callable=self._SetCheckerOptions)

        self._checker_download_control = ClientGUIControls.NetworkJobControl(
            checker_panel)
        ...
        imports_panel.Add(self._file_seed_cache_control,
                          CC.FLAGS_EXPAND_PERPENDICULAR)
        imports_panel.Add(self._file_download_control,
                          CC.FLAGS_EXPAND_PERPENDICULAR)
        ...
        QP.AddToLayout(hbox_1, self._file_velocity_status,
                       CC.FLAGS_VCENTER_EXPAND_DEPTH_ONLY)
        QP.AddToLayout(hbox_1, self._checking_pause_button, CC.FLAGS_VCENTER)

        hbox_2 = QP.HBoxLayout()

        QP.AddToLayout(hbox_2, self._watcher_status,
                       CC.FLAGS_VCENTER_EXPAND_DEPTH_ONLY)
        ...
        checker_panel.Add(self._gallery_seed_log_control,
                          CC.FLAGS_EXPAND_PERPENDICULAR)
        checker_panel.Add(self._checker_options_button,
                          CC.FLAGS_EXPAND_PERPENDICULAR)
        checker_panel.Add(self._checker_download_control,
                          CC.FLAGS_EXPAND_PERPENDICULAR)
    ...
    def _UpdateStatus(self):
        ...
        if self._watcher is not None:
            ...
            (file_status, files_paused, file_velocity_status, next_check_time,
             watcher_status, subject, checking_status, check_now,
             checking_paused) = self._watcher.GetStatus()
            ...
            if checking_paused:
                ...
                ClientGUIFunctions.SetBitmapButtonBitmap(
                    self._checking_pause_button, CC.GlobalPixmaps.gallery_play)
                ...
                if watcher_status == '' and next_check_time is not None:
                    ...
                    if HydrusData.TimeHasPassed(next_check_time):
                        ...
                        watcher_status = 'next check ' + HydrusData.TimestampToPrettyTimeDelta(
                            next_check_time, just_now_threshold=0)
            ...
            (file_network_job,
             checker_network_job) = self._watcher.GetNetworkJobs()
