...
class NetworkContext(HydrusSerialisable.SerialisableBase):
    ...
    def _GetSerialisableInfo(self):
        ...
        if self.context_data is None:
            ...
            if self.context_type in (CC.NETWORK_CONTEXT_DOMAIN,
    ...
    def _UpdateSerialisableInfo(self, version, old_serialisable_info):
        ...
        if version == 1:
            ...
            if serialisable_context_data is not None:
                ...
                if context_type in (CC.NETWORK_CONTEXT_DOMAIN,
                                    CC.NETWORK_CONTEXT_SUBSCRIPTION):
    ...
    def IsEphemeral(self):
        ...
        return self.context_type in (CC.NETWORK_CONTEXT_DOWNLOADER_PAGE,
    ...
    def GetSummary(self):
        ...
        summary += CC.network_context_type_description_lookup[
            self.context_type]
    ...
    def ToHumanString(self):
        ...
        if self.IsEphemeral():
            ...
            return CC.network_context_type_string_lookup[
                self.context_type] + ' instance'
    ...
    def ToString(self):
        ...
        if self.context_data is None:
            ...
            return CC.network_context_type_string_lookup[
                self.context_type] + ': ' + name

    @staticmethod
    def STATICGenerateForDomain(domain):

        return NetworkContext(context_type=CC.NETWORK_CONTEXT_DOMAIN,
                              context_data=domain)


HydrusSerialisable.SERIALISABLE_TYPES_TO_OBJECT_TYPES[
    HydrusSerialisable.SERIALISABLE_TYPE_NETWORK_CONTEXT] = NetworkContext
