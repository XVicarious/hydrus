        ...
        try:
            ...
            while True:
                ...
                try:
                    ...
                    HydrusData.ShowText('Daemon ' + self._name +
...
class JobScheduler(threading.Thread):
    ...
    def _FilterCancelled(self):
        ...
        with self._waiting_lock:
            ...
            self._waiting = [
                job for job in self._waiting if not job.IsCancelled()
            ]
...
class RepeatingJob(SchedulableJob):
    def __init__(self, controller, scheduler, initial_delay, period,
                 work_callable):

        SchedulableJob.__init__(self, controller, scheduler, initial_delay,
                                work_callable)
    ...
    def SetPeriod(self, period):
        ...
        if period > 10.0:
            ...
            )  # smooth out future spikes if ten of these all fire at the same time
