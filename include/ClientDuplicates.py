...
class DuplicateActionOptions(HydrusSerialisable.SerialisableBase):
    ...
    def __init__(self,
                 tag_service_actions=None,
                 rating_service_actions=None,
                 sync_archive=False,
    ...
    def _GetSerialisableInfo(self):
        ...
        if HG.client_controller.IsBooted():
            ...
            self._tag_service_actions = [
                ...
                for (service_key, action,
                     tag_filter) in self._tag_service_actions
                if services_manager.ServiceExists(service_key)
                and services_manager.GetServiceType(service_key) in (
        ...
        return (serialisable_tag_service_actions,
                serialisable_rating_service_actions, self._sync_archive,
    ...
    def SetTuple(self, tag_service_actions, rating_service_actions,
                 sync_archive, sync_urls_action):
    ...
    def ToTuple(self):
        ...
        return (self._tag_service_actions, self._rating_service_actions,
                self._sync_archive, self._sync_urls_action)
...
HydrusSerialisable.SERIALISABLE_TYPES_TO_OBJECT_TYPES[
    HydrusSerialisable.
    SERIALISABLE_TYPE_DUPLICATE_ACTION_OPTIONS] = DuplicateActionOptions
