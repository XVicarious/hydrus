...
class TestSerialisables(unittest.TestCase):
    ...
    def test_SERIALISABLE_TYPE_SHORTCUT(self):
        def test(obj, dupe_obj):
            ...
            self.assertEqual(dupe_obj.__hash__(),
                             (dupe_obj.shortcut_type, dupe_obj.shortcut_key,
                              dupe_obj.shortcut_press_type,
                              tuple(dupe_obj.modifiers)).__hash__())
        ...
        shortcuts.append(
            (ClientGUIShortcuts.Shortcut(CC.SHORTCUT_TYPE_KEYBOARD_CHARACTER,
                                         ...
                                         [CC.SHORTCUT_MODIFIER_CTRL]),
             'ctrl+a'))
        shortcuts.append((ClientGUIShortcuts.Shortcut(
            CC.SHORTCUT_TYPE_KEYBOARD_SPECIAL, CC.SHORTCUT_KEY_SPECIAL_HOME,
            CC.SHORTCUT_PRESS_TYPE_PRESS,
            [CC.SHORTCUT_MODIFIER_ALT, CC.SHORTCUT_MODIFIER_CTRL]),
                          'ctrl+alt+home'))
        ...
        shortcuts.append(
            (ClientGUIShortcuts.Shortcut(CC.SHORTCUT_TYPE_MOUSE,
             ...
             'ctrl+middle-click'))
        shortcuts.append((ClientGUIShortcuts.Shortcut(
            CC.SHORTCUT_TYPE_MOUSE, CC.SHORTCUT_MOUSE_SCROLL_DOWN,
            CC.SHORTCUT_PRESS_TYPE_PRESS,
            [CC.SHORTCUT_MODIFIER_ALT, CC.SHORTCUT_MODIFIER_SHIFT]),
    ...
    def test_SERIALISABLE_TYPE_SHORTCUT_SET(self):
        def test(obj, dupe_obj):
            ...
            for (shortcut, command) in obj:
                ...
                self.assertEqual(
                    dupe_obj.GetCommand(shortcut).GetData(), command.GetData())
        ...
        command_1 = ClientData.ApplicationCommand(
            CC.APPLICATION_COMMAND_TYPE_SIMPLE, 'archive_file')
        command_2 = ClientData.ApplicationCommand(
            CC.APPLICATION_COMMAND_TYPE_CONTENT,
            (HydrusData.GenerateKey(), HC.CONTENT_TYPE_MAPPINGS,
             HC.CONTENT_UPDATE_FLIP, 'test'))
        command_3 = ClientData.ApplicationCommand(
            CC.APPLICATION_COMMAND_TYPE_CONTENT,
            (CC.DEFAULT_LOCAL_TAG_SERVICE_KEY, HC.CONTENT_TYPE_MAPPINGS,
             HC.CONTENT_UPDATE_FLIP, 'test'))

        k_shortcut_1 = ClientGUIShortcuts.Shortcut(
            CC.SHORTCUT_TYPE_KEYBOARD_SPECIAL, CC.SHORTCUT_KEY_SPECIAL_SPACE,
            CC.SHORTCUT_PRESS_TYPE_PRESS, [])
        k_shortcut_2 = ClientGUIShortcuts.Shortcut(
            CC.SHORTCUT_TYPE_KEYBOARD_CHARACTER, ord('a'),
            CC.SHORTCUT_PRESS_TYPE_PRESS, [CC.SHORTCUT_MODIFIER_CTRL])
        k_shortcut_3 = ClientGUIShortcuts.Shortcut(
            CC.SHORTCUT_TYPE_KEYBOARD_CHARACTER, ord('A'),
            CC.SHORTCUT_PRESS_TYPE_PRESS, [CC.SHORTCUT_MODIFIER_CTRL])
        k_shortcut_4 = ClientGUIShortcuts.Shortcut(
            CC.SHORTCUT_TYPE_KEYBOARD_SPECIAL, CC.SHORTCUT_KEY_SPECIAL_HOME,
            CC.SHORTCUT_PRESS_TYPE_PRESS,
            [CC.SHORTCUT_MODIFIER_ALT, CC.SHORTCUT_MODIFIER_CTRL])

        m_shortcut_1 = ClientGUIShortcuts.Shortcut(
            CC.SHORTCUT_TYPE_MOUSE, CC.SHORTCUT_MOUSE_LEFT,
            CC.SHORTCUT_PRESS_TYPE_PRESS, [])
        m_shortcut_2 = ClientGUIShortcuts.Shortcut(
            CC.SHORTCUT_TYPE_MOUSE, CC.SHORTCUT_MOUSE_MIDDLE,
            CC.SHORTCUT_PRESS_TYPE_PRESS, [CC.SHORTCUT_MODIFIER_CTRL])
        m_shortcut_3 = ClientGUIShortcuts.Shortcut(
            CC.SHORTCUT_TYPE_MOUSE, CC.SHORTCUT_MOUSE_SCROLL_DOWN,
            CC.SHORTCUT_PRESS_TYPE_PRESS,
            [CC.SHORTCUT_MODIFIER_ALT, CC.SHORTCUT_MODIFIER_SHIFT])
        ...
        self.assertEqual(
            shortcut_set.GetCommand(k_shortcut_1).GetData(),
            command_1.GetData())
    ...
    def test_SERIALISABLE_TYPE_SUBSCRIPTION(self):
        ...
        queries = [
            ClientImportSubscriptions.SubscriptionQuery('test query'),
            ClientImportSubscriptions.SubscriptionQuery('test query 2')
        ]
        ...
        sub.SetTuple(gug_key_and_name, queries, checker_options,
